...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    private static final String GLOBAL_ACTION_KEY_REBOOT_DOWNLOAD = "reboot_download";
    ...
    private GlobalActionsDialog createDialog() {
        ...
        for (int i = 0; i < mMenuActions.length; i++) {
            ...
            } else if (advancedRebootEnabled(mContext) && GLOBAL_ACTION_KEY_REBOOT_DOWNLOAD.equals(actionKey)) {
                mItems.add(new RebootDownloadAction());
    ...
    private final class RebootDownloadAction extends SinglePressAction {
        private RebootDownloadAction() {
            super(com.android.internal.R.drawable.ic_lock_power_rebootdownload,
                    R.string.global_action_reboot_download);
        }
        ...
        @Override
        public void onPress() {
            mWindowManagerFuncs.reboot("download", false);
        }
    }
    ...
    private List<Action> getCurrentRebootMenuItems() {
        ...
        for (int i = 0; i < rebootMenuActions.length; i++) {
            ...
            if (advancedRebootEnabled(mContext) && GLOBAL_ACTION_KEY_REBOOT_RECOVERY.equals(actionKey)) {
                ...
                RebootDownloadAction a = new RebootDownloadAction();
                if (isActionVisible(a)) {
                    items.add(a);
                }
            }
